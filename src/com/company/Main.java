...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String [] array1 = new String [] {"A","B","C", "D", "E", "F", "G", "H", "I", "K", "L",
                "M", "N", "O", "P", "Q", "R", "S", "T", "V", "X", "Y", "Z", "_"};
        String [] array2 = new String[] {"a","b","c", "d", "e", "f", "g", "h", "i", "k", "l",
                "m", "n", "o", "p", "q", "r", "s", "t", "v", "x", "y", "z", "_"};

        String randomLatUppercase1 = generateRandomObj(array1);
        String randomLatUppercase2 = generateRandomObj(array1);
        String randomLatLowercase1 = generateRandomObj(array2);
        String randomLatLowercase2 = generateRandomObj(array2);
